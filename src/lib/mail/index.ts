 ...
 * ```
 */
export async function SendEmail(to:string, nombre:string, mail:{asunto:string, body:string}) {
  const senTFrom = new Sender("mitienditaonline@trial-jy7zpl9yvy0g5vx6.mlsender.net", "Mi Tiendita Online")
